        ...
        <div className="flex flex-col gap-[50px] items-center">
          ...
          <div className="grid grid-cols-4 gap-4">
            {planData.map((plan, index) => (
              <div key={index} className="shadow-md rounded-[10px] px-6 bg-white">
                <div className="h-[187px] pt-[21px] flex flex-col gap-[6px] border-b-2 border-[#CCCCCC]">
                  ...
                  <div>
                    ...
                    <p>{plan.number_of_account_for}</p>
                  </div>
                </div>
                <div className="h-[224px] py-5 flex flex-col gap-1">
                  {plan.facilities.map((facility, index) => (
                    <div className="flex gap-[13px]" key={index}>
                      <TickQuark />
                      <p className="w-[189.17px]">{facility}</p>
                    </div>
                  ))}
                </div>
